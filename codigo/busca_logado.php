...
<body>
    ...
    <header>
        ...
        <form action="busca_logado.php" method="GET">
            <input type="text" name="search" id="search" placeholder="Digite o Bairro" required>
            <button type="submit"><i class="fas fa-search"></i></button>
        </form>

        <a href="http://www.localhost/VOX/areacliente.html"> <button type="button"  class="btn btn-light">Cliente</button></a>
    ...
    <section>
        ...
        <div class="product">
            ...
            <div class="products">
                ...
                <a href="./Pagamento.html"> <button type="button" class="btn btn-danger" id="#btn">Alugue</button></a>
            </div>
        </div>
        </label>
        <br>
